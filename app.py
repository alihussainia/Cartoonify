...
call('sudo apt install python3-opencv', shell=True)
...
call('sudo apt-get -qq update', shell=True)
call('sudo apt-get -qq install ffmpeg libgl1 libsm6 libxext6  -y', shell=True)
